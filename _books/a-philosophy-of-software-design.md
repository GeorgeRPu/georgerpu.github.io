...
4. **Define errors out of existence.** Returning 0 exceptions is better than returning 1 is better than return 2 and so on, because exceptions are part of a module's interface, and complex interfaces lead to shallow modules.
