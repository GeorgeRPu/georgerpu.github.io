---
layout: post
title: "Federated Learning: FedAvg (Part 1)"
date: 2019-09-28
...
toc:
  sidebar: left
scholar:
  bibliography: 2019-12-02-fl-fedavg.bib
...
{% include figure.html path="assets/img/2019-12-02/federated-learning.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.html path="assets/img/2019-12-02/convex-loss.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.html path="assets/img/2019-12-02/loss-comm-round.png" class="img-fluid rounded z-depth-1" zoomable=true %}
