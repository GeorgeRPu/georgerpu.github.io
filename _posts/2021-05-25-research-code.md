...
Python, and most programming languages, allow explanatory comments to be placed beside confusing code. A special type of comment is a **doc comment** placed above a class/function definition. In Python, these are triple-quote strings, hence the name **docstring**, which go below the class/function definition. Docstring provide invaluable context to other researchers looking to build on top of your work. Others will need to understand the inner workings of your code before they can modify it. Docstrings also jog the memory when you revisit your code in the future as a stranger.
