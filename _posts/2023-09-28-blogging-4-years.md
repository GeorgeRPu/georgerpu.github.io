...
Four years ago, I published [my first blog post](https://georgerpu.github.io/blog/2019/the-cantor-set-minus-itself/). It was a simple proof that $C - C = [0, 1]$ where $C$ is the Cantor set. Since then I have published over a dozen posts about mostly mathematics and programming, but also the [book's I've read](https://georgerpu.github.io/blog/tag/books/), [economics](https://georgerpu.github.io/blog/2023/economic-possiblities-for-ourselves/), and [basketball](https://georgerpu.github.io/blog/2022/nba-mvp/). Blogging has been my most consistent[^1] side project or hobby in the past 4 years.
