...
<img src="https://hydra.cc/img/logo.svg" alt="Hydra" width="300" class="centerImage" />
...
[^1]: You can use `printf` to output the the console, but it is not recommended over using `std::cout`.
